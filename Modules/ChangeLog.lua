...
CHANGELOG_ELEMENTS = {
    ['Version 2.0.4'] = {
        ...
        {type = 'heading', text = [[Improved frame position saving & restoring]], level = 2, indent_level = 1},
        {type = 'text', text = [[The transmog frame has 2 modes now.|n|n- Outfit swap |n|n- Regular|n|nPositions for these 2 modes are saved and restored seperately for your convenience!]], indent_level = 2},
