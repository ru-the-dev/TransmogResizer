...
**BetterTransmog** is a World of Warcraft addon that enhances the Transmogrification and Collections UI with movable, resizable frames, dynamic grid layouts, and additional customization options. Reworked for the new transmog system in midnight, it provides a more flexible and immersive transmog experience!
...
1.  Open the Transmogrification window
...
Options can be adjusted in the addon settings: Open **Options** → **Addons** → **BetterTransmog**

Settings are saved automatically per Account. Your grid layout will automatically recalculate based on your chosen values and current frame size.

## Compatibility

⚠️ **Compatibility with other transmog addons has not been tested.** If you encounter issues when using BetterTransmog alongside other transmog-related addons, please let me know! If you'd like compatibility with a specific addon, feel free to request it.
