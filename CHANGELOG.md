# Version 2.0.4
Quite a major update containing many requested features and improvements! As usual, thank you for your feedback and support, if you have any, don't hesitate to open a issue on the github page!
...
- `/bettertransmog` or `/bettertransmog settings` (opens settings panel)
- `/bettertransmog outfits` (Opens the outfit swapping panel)
- `/bettertransmog changelog` (Opens the changelog panel)
